...
const CategoryScroll = () => {
  ...
  return (
    <div className="relative w-[95vw] flex justify-center h-32 mt-10 -m-10 bg-white dark:bg-[rgba(17,17,17)] overflow-hidden">
      ...
      <div className="absolute left-1 top-0 w-1/4 h-full bg-gradient-to-r from-white dark:from-[rgba(17,17,17)] to-transparent"></div>
      <div className="absolute right-0 top-0 w-1/4 h-full bg-gradient-to-r from-transparent to-white dark:to-[rgba(17,17,17)]"></div>
