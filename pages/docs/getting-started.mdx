...
Another thing to note is that PurGPT request bodies match __exactly__ the same thing that you would send over to OpenAI's API. This means that you can always use their [API Reference](https://platform.openai.com/docs/api-reference/introduction) to find information about what should be in the request body.
