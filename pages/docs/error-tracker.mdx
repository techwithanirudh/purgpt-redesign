...
<Callout type="info" emoji="❔">
    Looking for a full list of errors? Check the next page!
</Callout>

If some providers returned with errors but PurGPT found a valid response, there will be a `cache` field in the response body.
